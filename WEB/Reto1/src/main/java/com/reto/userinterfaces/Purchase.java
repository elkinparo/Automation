...
public class Purchase
{
    ...
    public static final Target CONFIRMATIONMESSAGE = Target.the("CONFIRMATIONMESSAGE")
            .located(By.xpath("//*[contains(text(),'Tu pedido ha sido confirmado, te mantendremos informado ante nuevas novedades')]"));
    public static final Target CLOSE = Target.the("CLOSE")
            .located(By.xpath("//*[contains(text(),'Tu pedido ha sido confirmado, te mantendremos informado ante nuevas novedades')]//preceding::span[1]"));
